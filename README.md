...
This is the official repository of the paper "Object size prediction from hand movement using a single RGB sensor". It contains the implementation, the dataset and the supplemental material our work.
